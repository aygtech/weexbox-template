...
__vue_options__.__file = "D:\\code\\work\\weexbox-template\\src\\page\\wb-navigator\\App.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-343b8011"
...
exports.default = {
  ...
  methods: {
    getHeight: function getHeight() {
      var navHeight = navigator.getHeight();
      modal.showToast({
        text: '\u72B6\u6001\u680F\u9AD8\u5EA6\uFF1A' + navHeight,
        duration: 1.5
      });
    },
    setLeftItems: function setLeftItems() {
    ...
    setRightItems: function setRightItems() {
      navigator.setRightItems([{
        text: '确定',
        color: '000000'
      }], function () {
    ...
    setCenterItem: function setCenterItem() {
      navigator.setCenterItem({
        text: 'weex-box',
        color: '000000'
      }, function () {
    ...
    setNavColor: function setNavColor() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('scroller', {
    ...
    staticClass: ["title"]
  }, [_vm._v("设置导航栏左边按钮(setLeftItems)")]), _c('div', {
    staticClass: ["button"],
    on: {
      "click": _vm.setLeftItems
    }
  }, [_c('text', {
    staticClass: ["button-text"]
  }, [_vm._v("设置导航栏左边按钮")])]), _c('div', {
    staticClass: ["empty"]
  }), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("设置导航栏右边按钮(setRightItems)")]), _c('div', {
    staticClass: ["button"],
    on: {
      "click": _vm.setRightItems
    }
  }, [_c('text', {
    staticClass: ["button-text"]
  }, [_vm._v("设置导航栏右边按钮")])]), _c('div', {
    staticClass: ["empty"]
  }), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("设置导航栏中间的按钮(setCenterItem)")]), _c('div', {
    staticClass: ["button"],
    on: {
      "click": _vm.setCenterItem
    }
  }, [_c('text', {
    staticClass: ["button-text"]
  }, [_vm._v("设置导航栏中间的按钮")])]), _c('div', {
    staticClass: ["empty"]
  }), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("设置导航栏颜色(setNavColor)")]), _c('div', {
    staticClass: ["button"],
    on: {
      "click": _vm.setNavColor
    }
  }, [_c('text', {
    staticClass: ["button-text"]
  }, [_vm._v("设置导航栏颜色")])]), _c('div', {
    staticClass: ["empty"]
  }), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("获取状态栏高度(getHeight)")]), _c('div', {
    staticClass: ["button"],
    on: {
      "click": _vm.getHeight
    }
